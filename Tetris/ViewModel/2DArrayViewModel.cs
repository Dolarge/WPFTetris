...
namespace Tetris.ViewModel
{
    ...
    public class Arrayof2DVIewmodel<T> : INotifyPropertyChanged
    {
        ...
        public Arrayof2DVIewmodel(int size1, int size2)
        {
            data = new T[size1, size2];
        }

        public static implicit operator T[,](Arrayof2DVIewmodel<T> a)
        {
            return a.data;
        }
    }
